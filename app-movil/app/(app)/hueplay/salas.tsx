...
import { claveI18nSala, rutaDeSala } from '../../../src/juego/hueplay/rutas';
      ...
      >
        {juego ? (
          <View style={[styles.iconoJuego, { backgroundColor: `${juego.color}22` }]}>
            <MaterialCommunityIcons name={juego.icono} size={18} color={juego.color} />
          </View>
        ) : null}
        ...
        <View style={{ flex: 1, minWidth: 0 }}>
          <Text style={{ color: colors.text, fontFamily: fonts.bodySemi }} numberOfLines={1}>
            {t(`hueplay.${claveI18nSala(s.juegoCodigo)}.titulo`)} ·{' '}
          ...
          <Text style={{ color: colors.textMuted, fontSize: 12 }} numberOfLines={1}>
            {s.estado === 'esperando'
              ...
              : s.estado === 'terminada'
                ? s.juegoCodigo === 'huescrabble' && s.ganadorSalaJugadorId === null
                  ? t('hueplay.scrabble.empateFin')
                  : s.ganadorSalaJugadorId === miAsiento?.salaJugadorId
                    ? t(`hueplay.${claveI18nSala(s.juegoCodigo)}.ganasteFin`)
                    : t(`hueplay.${claveI18nSala(s.juegoCodigo)}.perdisteFin`)
                : s.esMiTurno
                  ? t('hueplay.teToca')
                  : t('hueplay.esperando')}
          </Text>
