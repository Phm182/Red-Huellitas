...
try {
    ...
    foreach ($fotos as $index => $foto) {
        // rh_guardar_foto_post() corre el filtro de moderación con Gemini:
        // puede tardar 30-40s reales, y con 6 fotos esa espera se repite por
        // cada una. En ese rato la conexión a MySQL queda sin usarse, y el
        // hosting la cierra sola por inactividad -- sin este chequeo, el
        // INSERT de abajo se encuentra con la conexión muerta y revienta con
        // "MySQL server has gone away" en vez de simplemente guardar la foto.
    ...
    error_log('publicaciones/crear.php: ' . $e->getMessage());
    json_error('Error al crear la publicación. Intentá de nuevo.', 500);
}
