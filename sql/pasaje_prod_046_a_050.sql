-- =============================================================================
-- Pasaje producción: migraciones 046 → 050
-- Base que ya corrió pasaje_prod_025_a_045.sql (o equivalente hasta 045).
--
-- Incluye:
...
--
-- Correr UNA vez en prod (UTF-8):
--   mysql --default-character-set=utf8mb4 -u USUARIO -p NOMBRE_BD < sql/pasaje_prod_046_a_050.sql
-- =============================================================================
